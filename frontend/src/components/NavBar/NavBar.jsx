              ...
              <div className="relative" ref={profileMenuRef}>
                ...
                {showProfileMenu && (
                  <div className="absolute top-full right-0 mt-4 bg-white rounded-xl shadow-2xl min-w-[220px] z-50 overflow-hidden border border-gray-100">
                    ...
                    <button className="w-full py-3 px-4 text-left hover:bg-gray-50 text-sm text-gray-700 font-medium bg-transparent border-0 cursor-pointer" onClick={() => { setShowProfileMenu(false); navigate("/dashboard/profile"); }}>My Profile</button>
                    <button className="w-full py-3 px-4 text-left hover:bg-gray-50 text-sm text-gray-700 font-medium bg-transparent border-0 cursor-pointer" onClick={() => { setShowProfileMenu(false); navigate("/dashboard/settings"); }}>Settings</button>
