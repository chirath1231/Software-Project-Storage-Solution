...
// const [currentPlanGB, setCurrentPlanGB] = useState(0);
...
//     <h2 className="text-base font-bold text-gray-800 mb-4">Current Plan</h2>
...
//             style={{
//               width: `${Math.min((usedGB / currentPlanGB) * 100, 100)}%`,
//               background: "linear-gradient(to right, orange, #ff7a00)",
//             }}
//           />
//         </div>
//         <span className="text-sm font-semibold text-gray-600 w-12 text-right">
//           {Math.min(Math.round((usedGB / currentPlanGB) * 100), 100)}%
//         </span>
//       </div>
...
//       {/* Upgrade Button */}
//       <button
//         className="flex-shrink-0 bg-orange-500 hover:bg-orange-600 text-white font-semibold px-5 py-2 rounded-full text-sm transition"
  ...
  return (
    <div className="px-6 py-10 min-h-screen">
      ...
      {/* CURRENT PLAN STORAGE BAR */}
        <div className="bg-white rounded-2xl shadow-md border border-gray-200 p-5 mb-10 flex items-center gap-6 overflow-hidden relative">
