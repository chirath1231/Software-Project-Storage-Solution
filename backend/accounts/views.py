...
# Update imports to remove Notification models and serializers
from .models import Event
from .serializers import RegisterSerializer, LoginSerializer, GoogleAuthSerializer, EventSerializer

# --- NEW IMPORT LOCATION FOR NOTIFICATION HELPER ---
